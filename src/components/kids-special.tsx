...
const KidsSpecial = () => {
    ...
    const [kidsSpecial, setKidsSpecial] = useState<Movie[]>([])
    const fetchData = () => {
    ...
    useEffect(() => {
        const filteredMovies = dataList.filter(data => data.videoCategory === 'Kids Special')
        setKidsSpecial(filteredMovies)
    }, [dataList]);
