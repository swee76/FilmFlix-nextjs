...
const AnimeStories = () => {
    ...
    const [animeStories, setAnimeStories] = useState<Movie[]>([])
    ...
    useEffect(() => {
        const filteredMovies = dataList.filter(data => data.videoCategory === 'Anime Stories')
        setAnimeStories(filteredMovies)
    }, [dataList]);
