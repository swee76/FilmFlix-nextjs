...
const navigation = {
    ...
    social: [
        ...
        {
            name: 'GitHub',
            href: 'https://github.com/swee76/filmflix-nextjs',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        {
            name: 'YouTube',
            href: 'https://www.youtube.com/channel/UCLZyFqNTc2SzVgfyWVdZgiw',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        ...
                        <p className="text-sm leading-6 text-gray-300">
                            Elevating your movie streaming experience, one frame at a time
                        </p>
                    ...
                    <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold leading-6 text-white">Movie</h3>
                                <ul role="list" className="mt-6 space-y-4">
                                    {navigation.movie.map((item) => (
                                        <li key={item.name}>
                                            <Link href={item.href}
